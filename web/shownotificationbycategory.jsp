        ...
        <div class="container-fluid">
            ...
            <div class="contianer bg-success">
                <div class="row mt-4 mb-4">
                    <h4 class="text-white backbg p-4"> <center>Read All Notification</center></h4><hr>
                    <!--all blog fetching--> 
                    <%
                        NotificaionDao NDd = new NotificaionDao(ConnectionProvider.getConnect());
                        List<NotificationEntity> NELl = NDd.getAllNotificationByCategory(request.getParameter("category"));
//                        out.println("valuelof " + NELl);
                        int c = 0;
                    ...
                    <%}
                        if (c == 0) {
                            out.println("<h2><center><font color=white>NO Data found to this category.<br>Please try another category.</font></center></h2>");
                        }
