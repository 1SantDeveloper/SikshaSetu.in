...
<html>
    <head>
        ...
        <title>Sikshasetu ! Edit Book store :  Where student share their talent.</title>
                    ...
                    <div class="col-lg-12 ">    
                        <div class="card">
                            <div class="card-header text-center bg-success text-white">
                                ...
                                <p class="hint-text">Update Book or Notes in pdf format and upload it</p>
                            </div>             
                            <div class="card-body bg-primary text-white">	
                                <%
                                    BookDao BD=new BookDao(ConnectionProvider.getConnect());
                                    int id=Integer.parseInt(request.getParameter("BookId"));
                                    BookEntity BE=BD.getBookDetailByBookId(id);
                                %>
                                <form action="UpdateBookServlet" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" maxlength = "50" placeholder="eg. Book title or note title" required="required" value="<%=BE.getTitle()%>">
                                    </div>
                                    <div class="form-group">
                                        
                                        <input type="hidden" class="form-control" name="oldfile"  value="<%=BE.getFileName()%>">
                                        <input type="hidden" class="form-control" name="Bookid"  value="<%=BE.getId()%>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"  name="ckeditor" rows="2"><%=BE.getDesc()%></textarea>
                                        <script>
                                    ...
                                    <div class="form-group">
                                        <label for="formGroupExampleInput" class="form-label mt-4"><strong>Old Upload file : <%=BE.getFileName()%>   <font color=yellow>Recommended in pdf format.upload single file in pdf or image or zip format.</font></strong></label>
                                        <input type="file" class="form-control" name="file" required="required">

                                    </div>

                                    <div class="d-grid gap-2 mt-4">
                                        <input type="submit" class="btn btn-danger" value="Update Book ">
                                    </div>
                                </form>
                            </div>
                        </div
